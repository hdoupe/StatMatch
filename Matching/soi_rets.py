...
SOI.rename(columns={'recid': 'retid', 'xocah': 'cahe', 'xocawh': 'cafhe',
                    'xoodep': 'othdep', 'dsi': 'ifdept', 'agedp1': 'agedep1',
                    'agedp2': 'agedep2', 'agedp3': 'agedep3',
                    'xopar': 'parents', 'e00200': 'was', 'e00300': 'intst',
                    'e00400': 'texint', 'e00600': 'dbe', 'e00800': 'alimony',
                    'e00900': 'bil', 'e01500': 'pensions', 'e01700': 'ptpen',
                    'e02100': 'fil', 'e02300': 'ucagix', 'e02400': 'ssinc',
                    'e02500': 'ssagix', 'e00100': 'agix', 'e04800': 'tincx'},
           inplace=True)

# I wanted to include 'e02000' in SOI.rename list. But somehow the column is
# series before renaming, and DataFrame afterwards.
SOI['sche'] = SOI['e02000']
...
columns_to_keep = ['js', 'agedep1', 'agedep2', 'agedep3', 'parents', 'ifdept',
                   'cahe', 'cafhe', 'othdep', 'depne', 'agep', 'ages', 'agede',
                   'was', 'wasp', 'wass', 'intst', 'texint', 'dbe', 'alimony',
                   'bil', 'pensions', 'ptpen', 'sche', 'fil', 'ucagix',
                   'ssinc', 'ssincp', 'ssincs', 'ssagix', 'totincx', 'agix',
                   'tincx', 'returns', 'oldest', 'youngest', 'agepsqr',
                   'xagede', 'xifdept', 'xdepne', 'income', 'retid',
                   'sequence', 'soiseq', 'wt', 'filer']
