...
def add_nonfiler(cpsrets, nonfiler):
	...
	# there is not a xxpcawh in the variable list, but there is a xx*o*cawh
	# see cps_rets.py, output function
	xxocawh = nonfiler['xxocawh'] # xxocawh = nonfiler['xxocawh']
